...
export default function IndustryConnectView({ currentRole }) {
    ...
    <div className="page-container">
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '13.5px', color: '#64748B', fontWeight: 500 }}>
            Bridge real-world industry practices with 1:1 mentorships, hackathons, and faculty immersion programs.
          </p>
        </div>
      ...
      {activeSubTab === 'challenges' && (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(400px, 1fr))', gap: '20px' }}>
          {initialIndustryConnect.challenges.map((chal) => (
            <div
              key={chal.id}
              style={{
                background: '#FFFFFF',
            ...
            >
              ...
              <button
                onClick={() => alert(`Registered for ${chal.title}! Access instructions sent to email.`)}
                className="btn-primary"
                style={{ width: '100%', justifyContent: 'center' }}
              >
                <span>Register & Submit Solution</span>
                <ArrowRight size={15} />
              </button>
            </div>
          ))}
